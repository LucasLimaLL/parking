...
/**
 * <p>Classe NomeNaoInformadoPredicate responsável por</p>
 *
 * @author Lucas Lima
 * @since 04/11/2021
 **/
public class NomeNaoInformadoPredicate extends EstacionamentoPredicate {
    @Override
    ...
    public boolean test(Estacionamento estacionamento) {
        return StringUtils.isBlank(estacionamento.getNome());
    }
}

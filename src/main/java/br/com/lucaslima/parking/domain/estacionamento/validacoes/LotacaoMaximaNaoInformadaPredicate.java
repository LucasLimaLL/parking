...
/**
 * <p>Classe LotacaoMaximaNaoInformadaPredicate responsável por</p>
 *
 * @author Lucas Lima
 * @since 04/11/2021
 **/
public class LotacaoMaximaNaoInformadaPredicate extends EstacionamentoPredicate{
    @Override
    public String getMensagem() {
        return "Lotação máxima não informada.";
    }
    ...
    public boolean test(Estacionamento estacionamento) {
        return Objects.isNull(estacionamento.getLotacaoMaxima());
    }
}

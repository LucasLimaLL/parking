...
class TicketTest {
	...
	private Estacionamento estacionamento = new EstacionamentoBuilder()
			.identificador("00000000-0000-0000-0000-000000000000").nome("Estacionamento Teste")
	...
	private Veiculo veiculo = new VeiculoBuilder().tipoVeiculo(TipoVeiculo.CARRO.getOrdinal()).placa("AAA0000")
	...
	void testConstrutorSucessoComStatusEmAberto() {
		assertDoesNotThrow(() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
				.estacionamento(estacionamento).veiculo(veiculo).entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS))
				.status(new EmAbertoStatus()).build());
	}
	...
	void testConstrutorSucessoComStatusAguardandoPagamento() {
		assertDoesNotThrow(() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
				.estacionamento(estacionamento).veiculo(veiculo).entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS))
				.saida(LocalDateTime.now()).status(new AguardandoPagamentoStatus()).build());
	}
	...
	void testConstrutorSucessoComStatusCancelado() {
		assertDoesNotThrow(() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
				.estacionamento(estacionamento).veiculo(veiculo).entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS))
				.saida(LocalDateTime.now()).dataCancelamento(LocalDateTime.now()).motivoCancelamento("Motivo qualquer.")
				.status(new CanceladoStatus()).build());
	}
	...
	void testConstrutorSucessoComStatusFinalizado() {
		assertDoesNotThrow(() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
				.estacionamento(estacionamento).veiculo(veiculo).entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS))
				.saida(LocalDateTime.now()).estadia(Duration.ofHours(1)).dataFinalizado(LocalDateTime.now())
				.status(new FinalizadoStatus()).build());
	}
	...
	void testConstrutorFalhaSemIdentificador() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.status(new AguardandoPagamentoStatus()).build());
	...
	void testConstrutorFalhaSemEstacionamento() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000").veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.status(new AguardandoPagamentoStatus()).build());
	...
	void testConstrutorFalhaSemVeiculo() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS))
						.saida(LocalDateTime.now()).status(new AguardandoPagamentoStatus()).build());
	...
	void testConstrutorFalhaSemDataEntrada() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo).saida(LocalDateTime.now())
						.status(new AguardandoPagamentoStatus()).build());
	...
	void testConstrutorFalhaSemDataSaida() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).status(new AguardandoPagamentoStatus())
						.build());
	...
	void testConstrutorFalhaComDataDeEntradaPosteriorASaida() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().plus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.status(new AguardandoPagamentoStatus()).build());
	...
	void testConstrutorFalhaTicketCancelamentoSemMotivoDeCancelamentoInformado() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.dataCancelamento(LocalDateTime.now()).status(new CanceladoStatus()).build());
	...
	void testConstrutorFalhaTicketCancelamentoSemDataDeCancelamentoInformado() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.motivoCancelamento("Motivo qualquer.").status(new CanceladoStatus()).build());
	...
	void testConstrutorFalhaTicketFinalizadoSemDataDeFechamentoInformada() {
		Exception exception = assertThrows(Exception.class,
				() -> new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
						.estacionamento(estacionamento).veiculo(veiculo)
						.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
						.estadia(Duration.ofHours(1)).status(new FinalizadoStatus()).build());
	...
	void testPagarSucessoStatusEmAberto() {
		assertDoesNotThrow(() -> {
			Ticket ticket = new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
					.estacionamento(estacionamento).veiculo(veiculo)
					.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).status(new EmAbertoStatus()).build();
	...
	void testPagarFalhaStatusCancelado() {
		Exception exception = assertThrows(Exception.class, () -> {
			Ticket ticket = new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
					.estacionamento(estacionamento).veiculo(veiculo)
					.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
					.motivoCancelamento("Motivo de cancelamento qualquer.").dataCancelamento(LocalDateTime.now())
					.status(new CanceladoStatus()).build();
	...
	void testPagarFalhaStatusFinalizado() {
		Exception exception = assertThrows(Exception.class, () -> {
			Ticket ticket = new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
					.estacionamento(estacionamento).veiculo(veiculo)
					.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
					.dataFinalizado(LocalDateTime.now()).status(new FinalizadoStatus()).build();
	...
	void testFinalizarFalhaStatusCancelado() {
		Exception exception = assertThrows(Exception.class, () -> {
			Ticket ticket = new TicketBuilder().identificador("00000000-0000-0000-0000-000000000000")
					.estacionamento(estacionamento).veiculo(veiculo)
					.entrada(LocalDateTime.now().minus(1, ChronoUnit.HOURS)).saida(LocalDateTime.now())
					.dataCancelamento(LocalDateTime.now()).motivoCancelamento("Motivo de cancelamento qualquer.")
					.status(new CanceladoStatus()).build();

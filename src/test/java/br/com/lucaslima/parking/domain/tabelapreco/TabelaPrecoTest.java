...
class TabelaPrecoTest {
	...
	void testConstrutorSucesso() {
		TabelaPreco tabela = new TabelaPrecoBuilder().quinzeMinutos(BigDecimal.valueOf(2))
				.umaHora(BigDecimal.valueOf(8)).horaAdicional(BigDecimal.valueOf(5)).diaria(BigDecimal.valueOf(20))
				.build();
	...
	void testConstrutorSemInformarValorDe15min() {
		Exception exception = assertThrows(Exception.class, () -> {
			new TabelaPrecoBuilder().umaHora(BigDecimal.valueOf(8)).horaAdicional(BigDecimal.valueOf(5))
					.diaria(BigDecimal.valueOf(20)).build();
		});
	...
	void testConstrutorSemInformarValorDe1h() {
		Exception exception = assertThrows(Exception.class, () -> {
			new TabelaPrecoBuilder().quinzeMinutos(BigDecimal.valueOf(2)).horaAdicional(BigDecimal.valueOf(5))
					.diaria(BigDecimal.valueOf(20)).build();
		});
	...
	void testConstrutorSemInformarValorDeHoraAdicional() {
		Exception exception = assertThrows(Exception.class, () -> {
			new TabelaPrecoBuilder().quinzeMinutos(BigDecimal.valueOf(2)).umaHora(BigDecimal.valueOf(8))
					.diaria(BigDecimal.valueOf(20)).build();
		});
	...
	void testConstrutorSemInformarValorDeDiaria() {
		Exception exception = assertThrows(Exception.class, () -> {
			new TabelaPrecoBuilder().quinzeMinutos(BigDecimal.valueOf(2)).umaHora(BigDecimal.valueOf(8))
					.horaAdicional(BigDecimal.valueOf(5)).build();
		});
